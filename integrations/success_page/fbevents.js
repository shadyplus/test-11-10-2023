        ...
        (function () {
          ...
          function la(a) {
            ...
            switch (a) {
              ...
              case "startIWLBootstrap":
                var A = c[0],
                  B = c[1];
                ca.triggerWeakly({ graphToken: A, pixelID: B });
                break;
              case "parallelfire":
                var C = c[0],
                  D = c[1];
                W.pluginConfig.set(C, "parallelfire", { target: D });
                break;
              case "openbridge":
                var E = c[0],
                  F = c[1];
                E !== null &&
                  ...
                  typeof E === "string" &&
                  typeof F === "string" &&
                  (W.callMethod(["optIn", E, "OpenBridge"]),
                  W.pluginConfig.set(E, "openbridge", {
              ...
              case "trackSingleOnly":
                ...
                break;
              default:
                var L = W.pluginConfig.getWithGlobalFallback(
                    null,
                    "dataProcessingOptions"
                  ),
          ...
          function pa(a, b, c) {
            for (var d = 0, e = T.length; d < e; d++) {
              ...
              ta({ customData: b, eventData: c, eventName: a, pixel: f });
              Object.prototype.hasOwnProperty.call(V, a) && V[a].add(f.id);
            }
          }
          function qa(a, b) {
            ta({ customData: b, eventName: a, pixel: null });
          }
          function ra(a, b, c) {
            T.forEach(function (c) {
              return ta({ customData: b, eventName: a, pixel: c });
            });
          }
          function $(a) {
